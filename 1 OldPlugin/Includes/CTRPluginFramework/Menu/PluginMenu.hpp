...
namespace CTRPluginFramework
{
    ...
    public:
        ...
        ******************************/
         ...
         */
        PluginMenu(std::string name, u32 major, u32 minor, u32 revision, std::string about = "This is a plugin developed by DarkFlare that contains many popular MK7 hacks. Please be sure to read all of the notes for instructions on how to use a certain code. If there is a problem, report it on the official GBAtemp thread.");
